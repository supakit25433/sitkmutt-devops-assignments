...
docker run -d --name productpage -p 8083:8083 --link reviews:reviews --link ratings:ratings --link details:details -e 'DETAILS_HOSTNAME=http://details:8081' -e 'RATINGS_HOSTNAME=http://ratings:8080' -e 'REVIEWS_HOSTNAME=http://reviews:8082' -e FLOOD_FACTOR=0 productpage